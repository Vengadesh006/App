...
export const Chat = () => {
  return (
    <>
      <div className=" w-full h-[790px] max-h-full bg-transparent overflow-y-auto px-5 space-y-2">
        <div className="flex justify-start gap-3 mb-5">
          ...
          <div className="bg-gray-200 px-4 py-2 rounded-xl max-w-md">
            <h5 className='text-[#5b5594] text-[20px] font-medium mb-1' > Deve </h5>
            <p className="text-lg mb-1 text-[#191a1f] font-medium">I added new flows to our design system.
        ...
        <div className="flex ml-19">
          ...
          <div className="bg-gray-200 px-4 py-2 rounded-xl max-w-md">
            <h5 className='text-[#5b5594] text-[20px] font-medium mb-1' > Alex Hunt </h5>
        ...
        <div className="flex gap-4 mx-4 justify-start gap-3">
          ...
          <div className="">
            ...
            <div className="bg-gray-100 text-white px-4 py-4 rounded-xl max-w-xs">
              <h6 className='text-[#5b5594] font-medium text-[20px] mb-3' > Jessie Rollins </h6>
